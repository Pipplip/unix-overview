...
## Kurze Einführung in Distributionen und Paketmanagement
...
| Desktop-Umgebung | Typischer Schwerpunkt           | Ressourcenverbrauch | Anpassbarkeit |
|------------------|---------------------------------|---------------------|---------------|
| **GNOME**        | Modern, schlicht, fokussiert    | Mittel              | Mittel        |
| **KDE Plasma**   | Funktionsreich, Windows-ähnlich | Mittel              | Sehr hoch     |
| **Xfce**         | Leicht, klassisch, schnell      | Niedrig             | Hoch          |
| **Cinnamon**     | Klassischer Desktop             | Mittel              | Hoch          |
| **MATE**         | Klassisch, schlank              | Niedrig–Mittel      | Hoch          |
| **LXQt**         | Sehr leichtgewichtig            | Sehr niedrig        | Mittel        |
| **Budgie**       | Modern, klassisch               | Mittel              | Mittel        |
